...
var createNewTaskElement=function(taskString){
    ...
    deleteButton.className = 'delete__img';
    ...
    editInput.type="text";
    editInput.className="item__task item__input";

    editButton.innerText="Edit"; //innerText encodes special characters, HTML does not.
    editButton.className="item__btn btn";
...
var editTask=function(){
    ...
    var editBtn=listItem.querySelector(".item__btn");
...
//select ListItems children
    ...
    var editButton=taskListItem.querySelector(".item__btn");
